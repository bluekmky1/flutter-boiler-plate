...
import 'candidate_manage_view_modle.dart';
...
class _CandidateManageViewState extends ConsumerState<CandidateManageView> {
  ...
  Widget build(BuildContext context) {
    final CandidateManageState state =
        ref.watch(candidateManageViewModelProvider);
    final CandidateManageViewModel viewModel =
        ref.read(candidateManageViewModelProvider.notifier);
